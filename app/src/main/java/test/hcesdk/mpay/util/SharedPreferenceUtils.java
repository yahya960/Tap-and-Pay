...
public abstract class SharedPreferenceUtils {
    ...
    private static final String DELEGATED_CDCVM_STATUS = "delegated_cdcvm_status";
    ...
    public static boolean getDelegatedCDCVMStatus(Context context) {
        AppLogger.d(TAG, "isPushNotiDisabled");
        sp = context.getApplicationContext().getSharedPreferences(IS_PUSHNOTI_DISABLED, AppCompatActivity.MODE_PRIVATE);
        boolean delegatedCDCVMStatus = sp.getBoolean(DELEGATED_CDCVM_STATUS, false );
        AppLogger.d(TAG, "getDelegatedCDCVMStatus " + delegatedCDCVMStatus);
        return delegatedCDCVMStatus;
    }

    public static void setDelegatedCDCVMStatus(Context context, boolean status) {
        AppLogger.d(TAG, "isPushNotiDisabled");
        sp = context.getApplicationContext().getSharedPreferences(IS_PUSHNOTI_DISABLED, AppCompatActivity.MODE_PRIVATE);
        sp.edit().putBoolean(DELEGATED_CDCVM_STATUS, status).apply();
    }
    ...
    public static boolean checkIsFirstRun(Context context){
        sp = context.getApplicationContext().getSharedPreferences(IS_FIRST_RUN, Activity.MODE_PRIVATE);
        editor = sp.edit();
        return sp.getBoolean(IS_FIRST_RUN,true);
    }

    public static void setFirstRunUpdate(Context context){
        sp = context.getApplicationContext().getSharedPreferences(IS_FIRST_RUN, Activity.MODE_PRIVATE);
        editor = sp.edit();
        if (sp.getBoolean(IS_FIRST_RUN, true)) {
            sp.edit().putBoolean(IS_FIRST_RUN, false).commit();
        }
