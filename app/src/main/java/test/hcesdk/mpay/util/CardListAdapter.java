...
public class CardListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        mHolder.imageBtnSettings.setVisibility(View.VISIBLE);
        mHolder.imageBtnSettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                callback.onSettingsClicked(card);
            }
        });
    ...
    public interface CardListAdapterCallback {
        ...
        void onSettingsClicked(MyDigitalCard card);
    }

    private class MyViewHolder extends RecyclerView.ViewHolder {
        TextView tvInfo;
        CardView cardPayment;
        ImageButton imgBtnDelete, imgBtnSetDefault, imgBtnGetHistory, imgPayment, imageBtnSettings;
        ...
        public MyViewHolder(View itemView) {
            ...
            imageBtnSettings = itemView.findViewById(R.id.imgBtnSettings);
        }
    }
