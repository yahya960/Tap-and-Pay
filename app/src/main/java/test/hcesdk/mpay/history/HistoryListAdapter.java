...
public class HistoryListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
        AppLogger.i("HistoryListAdapter", "[HistoryListAdapter onCreateViewHolder]");
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        AppLogger.i("HistoryListAdapter", "[HistoryListAdapter onBindViewHolder]");
    ...
    public int getItemCount() {
        AppLogger.i("HistoryListAdapter", "[HistoryListAdapter transactionHistory.size() = ]" + transactionHistory.size());
